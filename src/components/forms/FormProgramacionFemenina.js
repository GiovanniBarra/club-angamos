...
const FormProgramacionFemenina = () => {
    return (
                ...
                <div className="row justify-content-around" >
                    ...
                    <div className='col-lg-6'>
                        <form className='rounded border border-2 border-warning' style={{marginTop: 5 + "%", marginBottom: 5 + "%", backgroundColor: "#106c44"}}>
                            ...
                            <h1>Programación serie femenina</h1>
                            </div>
                            ...
                            <div style={{margin: 5 + "%"}}>
                                <label className="form-label">Ingrese horario Serie Femenina</label>
...
export default FormProgramacionFemenina